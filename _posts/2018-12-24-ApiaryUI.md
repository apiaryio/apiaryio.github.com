...
I would like to wish all Apiary users Mary Christmas and Happy new Year. We are thrilled to 
welcome all Apiary users to try the new ApiaryUI - Interactive Documentation v4. 
Follow this [help page](https://help.apiary.io/tools/interactive-documentation-v4/) to get information how to enable ApiaryUI on your existing API Projects.
...
I would like to give special thanks to Patrick Silva, Radek Podrazsky and Standa Opichal.
